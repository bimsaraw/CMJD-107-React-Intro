        ...
        <div className="container mx-auto pt-5 pb-5">
            ...
            <div className="mt-10 w-[650px] border border-slate-200 px-4 py-3 rounded-lg">
                ...
                <div className="mb-4">
                    ...
                    <input type="text" className="block w-full p-2 border border-slate-300 rounded-lg text-slate-600 text-sm" onChange={handleProductName} />
                </div>

                <div className="mb-4">
                    <label className="text-sm text-slate-600 block mb-3">Enter product price</label>
                    <input type="number" className="block w-full p-2 border border-slate-300 rounded-lg text-slate-600 text-sm" onChange={handleProductPrice} />
                </div>

                <div className="mb-4">
                    <label className="text-sm text-slate-600 block mb-3">Enter category id</label>
                    <select className="block w-full p-2 border border-slate-300 rounded-lg text-slate-600 text-sm" onChange={handleCategoryId} >
                ...
                <div className="mb-4">
                    ...
                    <textarea className="block w-full p-2 border border-slate-300 rounded-lg text-slate-600 text-sm" onChange={handleDescription}></textarea>
                </div>
